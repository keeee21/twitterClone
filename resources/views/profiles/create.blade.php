<x-app-layout>
    <x-slot name="header">
        <a href="{{route('dashboard')}}"><h2 class="font-semibold text-xl text-gray-800 leading-tight">タイムライン</h2></a>
    </x-slot>
                ...
                <div class="mt-8">createだよ
                    ...
                    @csrf
                        <div class="mb-8">
                            ...
                            <input name="screen_name" value="" type="text" id="screen_name" class="w-full py-2 border-b focus:outline-none focus:border-b-2 focus:border-indigo-500 placeholder-gray-500 placeholder-opacity-50" placeholder="アカウント太郎">
                        </div>
                        <div class="mb-8">
