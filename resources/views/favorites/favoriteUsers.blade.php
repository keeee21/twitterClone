                    ...
                    <a href="{{route('profile.show',['id' => $favoriteUser->User->UserProfile->user_id])}}">
                        <div class="my-5 py-5 flex justify-around border focus:outline-none focus:border-b-2 focus:border-indigo-500">
                            <div class="my-2">
                                ...
                                @else
                                    <img class="w-20 h-20 rounded" src="{{asset($favoriteUser->User->UserProfile->icon_image)}}" width="100" height="100">
                                @endif
                            </div>
                            <div class="my-5">{{ $favoriteUser->User->UserProfile->screen_name }}</div>
